...
```{r, echo=TRUE}
# create a new dataset called datActivity2, which will contains filled values for NAs
...
# confirm that there is no missing value
sum(is.na(datActivity2))
```
...
**NOTE:  The impact of imputing missing data with the mean for the 5-minute interval causes the increase in counts for the 10766-step days (e.g. see 2012-10-01 above).  Such an increase is also evident in the new histogram #2 below.**
